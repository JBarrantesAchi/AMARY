...
if(document.getElementById('btnLogin')){
    ...
    const usuarioEspecifico = "amarycr.sa@gmail.com";
    const contrasenaEspecifica = "22Marzo23Login";

    if (correo !== usuarioEspecifico || password !== contrasenaEspecifica) {
        mostrarError('Usuario o contraseña incorrectos', msError);
        inputError([formLogin.correo, formLogin.password]);
        return false;
    } else {
        inputErrorRemove([formLogin.correo, formLogin.password]);
        formLogin.submit();
        window.location.href = "http://ally.amarycr.com/";
        return true;
    }
